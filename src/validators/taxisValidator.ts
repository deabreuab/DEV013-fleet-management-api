...
const getATaxiValidator = [param('taxiId').isInt().withMessage('The taxi id must be an integer')]
...
const deleteATaxiValidator = [param('taxiId').isInt().withMessage('The taxi id must be an integer')]
